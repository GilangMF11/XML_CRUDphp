...
<head>
    <meta charset="utf-8">
    <title>Operasi CRUD file XML Menggunakan PHP</title>
    <link rel="stylesheet" type="text/css" href="bootstrap/css/bootstrap.css">
</head>

<body>
    <div class="container">
        <h1 class="page-header text-center">Operasi CRUD file XML Menggunakan PHP</h1>
        <div class="row">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#delete_<?php echo $row->id; ?>" data-toggle="modal" class="btn 
